        ...
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-4xl">
                    ...
                    >
                        <a href="https://form.typeform.com/to/gxR8JkE0" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-neon-cyan hover:bg-[#00c8ff] text-obsidian font-bold rounded-lg transition-all flex items-center justify-center gap-2 group relative overflow-hidden">
