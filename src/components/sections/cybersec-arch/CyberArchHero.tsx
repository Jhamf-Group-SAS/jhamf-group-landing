            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-4xl">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-neon-ice/10 border border-neon-ice/20 mb-6"
                    >
                        <ShieldCheck className="w-4 h-4 text-neon-ice" />
                        <span className="text-sm font-medium text-neon-ice tracking-wide uppercase">
                    ...
                    >
                        {t('hero.title').split(' ').map((word, i) => (
                            <span key={i} className={word.includes('Zero-Trust') || word.includes('Empresarial') ? "text-transparent bg-clip-text bg-gradient-to-r from-electric-glow to-neon-ice" : ""}>
                                {word + ' '}
                            </span>
                        ))}
                    </motion.h1>
                    ...
                    >
                        <a href="https://form.typeform.com/to/gxR8JkE0" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-neon-ice hover:bg-[#00c8ff] text-void font-bold rounded-lg transition-all flex items-center justify-center gap-2 group relative overflow-hidden">
                        ...
                        <a href="https://wa.me/573022388714" target="_blank" rel="noreferrer" className="px-8 py-4 bg-white/5 hover:bg-white/10 text-white rounded-lg transition-all flex items-center justify-center gap-2 font-medium border border-white/10 group">
                            ...
                            <PhoneCall className="w-5 h-5 text-gray-400 group-hover:text-neon-ice transition-colors relative z-10" />
                        </a>
                    </motion.div>
                </div>
            </div>
