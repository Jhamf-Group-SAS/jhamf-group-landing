        ...
        <section className="py-24 bg-void relative overflow-hidden border-t border-b border-white/5 line-bg">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-16">
                    ...
                    <div className="w-20 h-1 bg-neon-ice rounded-full mx-auto" />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                    {items.map((item, i) => (
                        <motion.div
                            ...
                            className="bg-black/40 border border-white/5 rounded-xl p-6 text-center hover:border-neon-ice/30 transition-colors group"
                        >
                            <div className="w-10 h-10 mx-auto bg-white/5 rounded-full flex items-center justify-center mb-4 group-hover:bg-neon-ice/10 transition-colors">
                                <Check className="w-5 h-5 text-gray-400 group-hover:text-neon-ice" />
                            </div>
