...
const SupportCTA: React.FC = () => {
    ...
    return (
        <section className="py-24 bg-obsidian relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-b from-transparent to-signal/5" />
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                >
                    ...
                    <a href="https://form.typeform.com/to/gxR8JkE0" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 bg-signal text-obsidian rounded-lg font-bold text-lg hover:bg-[#00e68d] hover:shadow-[0_0_30px_rgba(0,255,157,0.3)] transition-all group relative z-10">
                        {t('cta.button')}
