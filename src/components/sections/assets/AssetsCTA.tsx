    ...
    return (
        <section className="relative py-28 bg-void overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-[-20%] right-[10%] w-[50%] h-[70%] rounded-full bg-plasma/10 blur-[160px]" />
                <div className="absolute bottom-[-20%] left-[10%] w-[40%] h-[60%] rounded-full bg-neon-ice/8 blur-[140px]" />
            </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                >
                    {t('cta.title')}{' '}
                    <span className="text-gradient-plasma">{t('cta.titleHighlight')}</span>
                </motion.h2>
                ...
                >
                    <a
                        ...
                        className="group relative inline-flex items-center gap-2 px-10 py-4 font-semibold text-white rounded-xl text-base overflow-hidden transition-all duration-300 hover:scale-[1.02]"
